...
class OrdersRepository {
    static createOrder(cliente_id, id_gorra, cantidad, total, created_by) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // 6. Insertar una nueva orden en la tabla Orders
                const orderSql = "INSERT INTO Orders (cliente_id, id_gorra, status,cantidad, total, created_by, updated_by) VALUES (?, ?, ?, ?, ?,?,?)";
                const [orderResult] = yield (0, database_1.query)(orderSql, [
                    cliente_id,
                    id_gorra,
                    "Pendiente",
                    cantidad,
    ...
    static getAllPendingOrdersWithCustomer(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // 1. Obtener todas las órdenes con estatus "Pendiente"
                const ordersSql = 'SELECT * FROM Orders WHERE cliente_id = ?';
                const [ordersRows] = yield (0, database_1.query)(ordersSql, [id]);
    ...
    static getAllOrdersAsignedDate() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const ordersSql = "SELECT * FROM Orders WHERE date IS NULL AND status = 'Pendiente'";
                const [ordersRows] = yield (0, database_1.query)(ordersSql);
                if (ordersRows.length === 0) {
                ...
                const ordersWithCustomer = yield Promise.all(ordersRows.map((order) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const [customerRows] = yield (0, database_1.query)(customerSql, [
                        order.cliente_id,
                    ]);
                    if (customerRows.length === 0) {
                        throw new Error(`No customer found for id ${order.cliente_id}`);
    ...
    static getAllCompletedOrCancelledOrdersWithCustomer() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const ordersSql = 'SELECT * FROM Orders WHERE date IS NOT NULL AND status= ?';
                const [ordersRows] = yield (0, database_1.query)(ordersSql, ["Pendiente"]);
                if (ordersRows.length === 0) {
    ...
    static getOrderDetails() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const [orderRows] = yield (0, database_1.query)(orderSql, ["Completado", "Cancelado"]);
    ...
    static getOne(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // 1. Obtener todas las órdenes con estatus "Pendiente"
                const ordersSql = 'SELECT * FROM Orders WHERE id = ?';
                const [ordersRows] = yield (0, database_1.query)(ordersSql, [id]);
                if (ordersRows.length === 0) {
                    throw new Error("No pending orders found");
                }
