...
class OrderService {
    static createOrder(cliente_id, id_gorra, cantidad, total, created_by) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield ordesRepository_1.OrdersRepository.createOrder(cliente_id, id_gorra, cantidad, total, created_by);
            }
            catch (error) {
    ...
    static getAllPendingOrdersWithCustomer(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield ordesRepository_1.OrdersRepository.getAllPendingOrdersWithCustomer(id);
            }
            catch (error) {
    ...
    static getOrderDetails() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield ordesRepository_1.OrdersRepository.getOrderDetails();
            }
            catch (error) {
                throw new Error(`Error al obtener las orden: ${error.message}`);
            }
    ...
    static getOne(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield ordesRepository_1.OrdersRepository.getOne(id);
            }
            catch (error) {
                throw new Error(`Error al obtener los detalles de la compras: ${error.message}`);
            }
