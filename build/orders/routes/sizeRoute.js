...
exports.orderRoute.get("/pending/:id", orderController_1.getAllPendingOrdersWithCustomer);
...
exports.orderRoute.get("/details/order", orderController_1.getOrderDetails);
exports.orderRoute.get("/details/compras/:cliente_id", orderController_1.getshoppingClient);
exports.orderRoute.get("/:id", orderController_1.getOne);
