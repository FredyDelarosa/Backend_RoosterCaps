...
class CapsRepository {
    static createCaps(categoria_id, name, price, created_by, imagen, talla, tipo, descripcion) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const sql = "INSERT INTO caps (categoria_id, name, price, created_by, updated_by, imagen,talla_id,tipo,descripcion) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
                const params = [
                    categoria_id,
                    name,
                    price,
    ...
    static updateCap(name2, name, price, updated_by, imagen, descripcion, tipo, talla, categoria_id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const sql = "UPDATE caps SET name = ?, price = ?, updated_by = ?, imagen = ?,categoria_id=?,tipo=?, descripcion=? WHERE name = ? and talla_id = ?";
    ...
    static getAllCaps() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const [rows] = yield (0, database_1.query)(sql, [false]);
