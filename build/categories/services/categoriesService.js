...
class CategoriaService {
    static createCategorie(name) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield categoriesRepository_1.CategorieRepository.createCategorie(name);
            }
            catch (error) {
    ...
    static updateCategorie(id, name) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield categoriesRepository_1.CategorieRepository.updateCategorie(id, name);
            }
            catch (error) {
                throw new Error(`Error al crear categorie: ${error.message}`);
            }
