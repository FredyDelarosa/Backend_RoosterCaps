...
class InventaryService {
    ...
    static updateInventary(name, cantidad, updated_by, talla_id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield inventaryRepository_1.InventaryRepository.updateInventary(name, cantidad, updated_by, talla_id);
            }
            catch (error) {
    ...
    static getAllInventariesActive(id_talla, name) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield inventaryRepository_1.InventaryRepository.getAllInventariesActive(id_talla, name);
            }
            catch (error) {
    ...
    static getAllInventariCaps(name) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield inventaryRepository_1.InventaryRepository.getAllInventariCaps(name);
            }
            catch (error) {
