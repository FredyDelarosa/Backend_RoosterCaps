...
const updateInventary = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const updatedInventary = yield InventarySerives_1.InventaryService.updateInventary(Number(name), cantidad, updated_by, talla_id);
...
const getAllInventariesActive = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const allActiveInventaries = yield InventarySerives_1.InventaryService.getAllInventariesActive(data.id_talla, data.name);
...
const getAllInventaryCaps = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const allActiveInventaries = yield InventarySerives_1.InventaryService.getAllInventariCaps(req.params.name);
        res.status(200).json(allActiveInventaries);
    }
    catch (error) {
        res.status(500).json({ error: error.message });
